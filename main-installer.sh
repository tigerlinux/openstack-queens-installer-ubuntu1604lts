...
# Version: 1.0.2.ub1604lts "Panthera tigris"
# November 04, 2018
#
...
"install")
	...
	echo "Flavor: OpenStack QUEENS for Ubuntu 16.04lts"
	echo "Made by: Reynaldo R. Martinez P."
	echo "E-Mail: TigerLinux@Gmail.com"
	echo "Version 1.0.2.ub1604lts \"Panthera tigris\" - November 04, 2018"
	echo ""
	...
	echo "- Ubuntu Cloud Archive QUEENS repository must be enabled and available"
	...
	*)
	...
	echo ""
	echo "Installing extra requeriments"
	echo ""
	...
	then
		echo ""
		echo "Extra requeriments ready. Continuing"
		echo ""
	else
		echo ""
		echo "Extra requirements installation failed. Aborting !!"
		echo ""
		exit 0
	fi
