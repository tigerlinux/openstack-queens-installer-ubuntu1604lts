...
openstack endpoint create --region $endpointsregion \
	data-processing public "http://$saharahost:8386/v1.1/\$(tenant_id)s"

openstack endpoint create --region $endpointsregion \
	data-processing internal "http://$saharahost:8386/v1.1/\$(tenant_id)s"

openstack endpoint create --region $endpointsregion \
	data-processing admin "http://$saharahost:8386/v1.1/\$(tenant_id)s"
